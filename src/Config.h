...
#define WIFISSID "WIFSSID"                             ///< Wi-Fi network SSID key
#define WIFIPASS "WIFPASS"                             ///< Wi-Fi network password key
#define RESET_FLAG "RST"                               ///< Key to trigger a reset operation
...
#define ALERT_TIME_SAVED "ALRTIM"                       ///< Key for saving the alert time
...
#define PROG_SWITCH_PIN 1                                  ///< Pin for the switch
